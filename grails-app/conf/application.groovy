...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'josproject.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'josproject.UserRole'
grails.plugin.springsecurity.authority.className = 'josproject.Role'
grails.plugin.springsecurity.logout.postOnly = false
grails.plugin.springsecurity.successHandler.defaultTargetUrl = '/announce'
